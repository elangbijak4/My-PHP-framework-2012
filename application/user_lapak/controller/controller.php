...
//Fungsi2 CRUID:
function default_cruid_controller($tabel,$database,$judul,$pilihan1,$aksi,$Recordset1) {
	$array_atribut = array();
...
*/
function CRUID_utama($tabel,$database,$judul,$pilihan1,$proses,$aksi,$coba,$key_cari,$kolom_cari,$id,$lokasi,$kolom_hapus_file,$Recordset1) {
	if ($aksi==tampil_semua) {default_cruid_controller($tabel,$database,$judul,$pilihan1,$aksi,$Recordset1);}		

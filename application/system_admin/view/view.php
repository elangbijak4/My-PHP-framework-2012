...
echo "<td width='30' valign=top><div align='center' onclick='tampilkandata(\"GET\",\"../controller/gerbang.php\",\"pilihan=$submenu&aksi=rincian&id=".$tampung[0]."\",\"#penampil\",\"#pra\")' >Rincian</div></td>";
echo "<td width='30' valign=top><div align='center' onclick='tampilkandata(\"GET\",\"../controller/gerbang.php\",\"pilihan=$submenu&aksi=edit&id=".$tampung[0]."\",\"#penampil\",\"#pra\")'>Edit</div></td>";
echo "<td width='30' valign=top><div align='center' onclick='tampilkandata(\"GET\",\"../controller/gerbang.php\",\"pilihan=$submenu&aksi=hapus&id=".$tampung[0]."\",\"#penampil\",\"#pra\")'>Hapus</div></td>";
foreach ($row_Recordset1 as $isi) {echo "<td align=left valign=top>".$isi."</td>";} 
